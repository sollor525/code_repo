...
> Author: 
> Mail: 
> Created Time: Wed 27 Jun 2018 04:26:13 PM CST
************************************************************************/
...
Status Init(HashTable *hashTable)
{
    ...
    hashTable->elem = (int *)malloc(HASHSIZE * sizeof(int)); //申请内存
...
int main()
{
    int i, j, result;
    HashTable hashTable;
    int arr[HASHSIZE] = {13, 13, 29, 29, 27, 28, 26, 30, 38};
